...
- Updated the Font Size control so it only targets host-page content, leaving the `<html>` element and accessibility modal visuals untouched and preventing the unintended `--acc-modal-scale` styling on the widget.
