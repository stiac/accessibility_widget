...
## Recent Activities
- 2025-11-12 — Replaced the Text Align button grid with the streamlined single-card toggle and helper copy so it matches other controls while staying screen-reader friendly (AI assistant)
