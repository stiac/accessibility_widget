...
## Recent Activities
- 2025-11-04 — Counter-scaled the accessibility modal via CSS so the Font Size control leaves its typography and spacing untouched while enlarging host content (AI assistant)
